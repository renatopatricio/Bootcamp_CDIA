...
# RF Balanced → deve melhorar recall da classe 1, sem muito oversampling.

# RF + SMOTE → pode aumentar recall ainda mais, mas com risco de gerar mais falsos positivos.

# XGBoost → tende a dar o melhor equilíbrio (boa precisão + melhor recall que baseline).